...
## Summary
I just found this issue when I were supporting one of my client.
I recommended you that you should not use the legacy version of the outlook app if you are using Mac OS.
If you select file label and send the mail in the legacy outlook, the mail can't be delivered or the recipient can't check your message.
